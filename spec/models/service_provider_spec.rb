RSpec.describe ServiceProvider, type: :model do
  ...
  describe 'Database' do
    describe 'table' do
      ...
      it { is_expected.to have_db_column :variant }
  ...
  describe 'Instance methods' do
    ...
    describe 'Logotype' do
      ...
      it 'is valid  ' do
        subject.logotype.attach(io: File.open(fixture_path + '/dummy_logo.png'),
                                filename: "logo-#{subject.name.underscore}_logotype.png", content_type: 'image/png')
    ...
    describe 'Banner' do
      subject { create(:service_provider) }
      it 'is valid  ' do
        subject.banner.attach(io: File.open(fixture_path + '/dummy_banner.jpg'),
                              filename: "logo-#{subject.name.underscore}_banner.png", content_type: 'image/jpg')
